...
export const DEFAULT_COMPLEX_DATA: ComplexInfo = {
  ...
  views: [
    ...
    {
      id: 'view-aerial',
      title: 'Vue Aérienne & Environnement Baguida',
      subtitle: 'Proximité immédiate du littoral et des grands axes',
      category: 'aerial',
      imageUrl: 'https://images.unsplash.com/photo-1512917774080-9991f1c4c750?auto=format&fit=crop&w=1600&q=80',
      description: 'Proche des plages de Baguida, à 15 minutes du Port Autonome de Lomé et 20 minutes de l\'Aéroport International Gnassingbé Eyadéma.',
    },
    {
      id: 'view-facade',
